...
<template>
    <div class="flex p-8 justify-center">
        <input type="text" class="rounded border-2 border-gray-200 w-full" v-model="searchedKeyword"
            placeholder="Search for Meals" @change="searchByName" />
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5 p-8">
        <div v-for="meal of meals" :key="meal.idMeal" class="bg-white drop-shadow-md rounded-xl hover:shadow-lg">
            ...
            <div class="px-2 pt-2">
                ...
                <div class="pb-2 m-2">
                    ...
                    <RouterLink to="/" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">View</RouterLink>
                </div>
            </div>
        </div>
    </div>
